...
{
  return mrb_iv_get(mrb, self, mrb_intern_lit(mrb, "minor_version"));
}
...
{
  return mrb_iv_get(mrb, self, mrb_intern_lit(mrb, "msg"));
}

static mrb_value
mrb_phr_headers(mrb_state *mrb, mrb_value self)
{
  return mrb_iv_get(mrb, self, mrb_intern_lit(mrb, "headers"));
}
...
mrb_phr_parse_request(mrb_state *mrb, mrb_value self)
{
  ...
  pret = phr_parse_request(RSTRING_PTR(request_obj), (size_t) RSTRING_LEN(request_obj),
  ...
  if (pret == -2) {
    ...
    mrb_iv_set(mrb, self, mrb_intern_lit(mrb, "request_obj"), request_obj);
...
mrb_phr_parse_response(mrb_state *mrb, mrb_value self)
{
  ...
  pret = phr_parse_response(RSTRING_PTR(response_obj), (size_t) RSTRING_LEN(response_obj),
  ...
  if (pret == -2) {
    ...
    mrb_iv_set(mrb, self, mrb_intern_lit(mrb, "response_obj"), response_obj);
    mrb_iv_set(mrb, self, mrb_intern_lit(mrb, "minor_version"),
      mrb_fixnum_value(minor_version));
...
mrb_phr_parse_headers(mrb_state *mrb, mrb_value self)
{
  ...
  pret = phr_parse_headers(RSTRING_PTR(headers_obj), (size_t) RSTRING_LEN(headers_obj),
    headers, &num_headers, (size_t) last_len);
  ...
  if (pret == -2) {
    ...
    mrb_iv_set(mrb, self, mrb_intern_lit(mrb, "headers_obj"), headers_obj);
    mrb_iv_set(mrb, self, mrb_intern_lit(mrb, "headers"),
      mrb_phr_headers_to_a(mrb, headers, num_headers));
...
{
  mrb_iv_remove(mrb, self, mrb_intern_lit(mrb, "request_obj"));
  mrb_iv_remove(mrb, self, mrb_intern_lit(mrb, "response_obj"));
  mrb_iv_remove(mrb, self, mrb_intern_lit(mrb, "headers_obj"));
